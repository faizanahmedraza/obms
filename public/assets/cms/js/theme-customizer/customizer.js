...
$(document).ready(function () {
      $(".customizer-color li").on('click', function() {
        ...
        $("#color" ).attr("href", "../assets/cms/css/"+color+".css" );
    ...
    $('.sidebar-type li').on('click', function () {
        ...
        switch (type) {
            ...
            case 'normal-sidebar': {
                ...
                $(".logo-wrapper").find('img').attr('src', '../assets/cms/images/logo/logo.png');
