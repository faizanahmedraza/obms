...
class VenueController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('cms.admin.venue.index', compact('venues'));
    }
    ...
    public function create()
    {
        ...
        return view('cms.admin.venue.create',compact('venueUsers','venue_types'));
    }
    ...
    public function store(Request $request)
    {
        ...
        DB::commit();
        return redirect()->route('admin.venues.index')->with('success', 'Successfully added.');
    }
    ...
    public function update($id, Request $request)
    {
        ...
        return redirect()->route('admin.venues.index')->with('success', 'Successfully updated.');
    }
    ...
    public function destroy($id)
    {
        ...
        $code = 200;
        $venue = VenueService::where('id', $id)->first();
        if (empty($venue)) {
