            ...
            <div class="agent-details-content">
                <div class="agents-block-one">
                    <div class="inner-box mr-0">
                        <iframe width="100%" height="583" src="https://my.matterport.com/show/?m=ywyx7vWrvhN"
                                frameborder="0" allowfullscreen=""
                                allow="vr" data-uw-styling-context="true"></iframe>
                        <div class="content-box pl-0">
                            <div class="upper clearfix">
                                <div class="title-inner pull-left">
                                    <h4>Arbat Banquet Hall</h4>
                            ...
                            <div class="text">
                                <p>Success isn’t really that difficult. There is a significant portion of the population
                                    here in North America, that actually want and need success to be hard! Why? So they
                                    then have a built-in excuse.when things don’t go their way! Pretty sad situation, to
                                    say the least. Have some fun and hypnotize yourself to be your very own Ghost of
                                    Christmas future”</p>
                            </div>
                            <ul class="info clearfix mr-0">
                                <li><i class="fab fa fa-envelope"></i><a href="mailto:bean@realshed.com">info@arbatlawn.com</a>
                                </li>
