<div class="page-main-header">
    <div class="main-header-right row m-0">
        <div class="main-header-left">
            <div class="logo-wrapper"><a href="{{isAdmin() ? route('admin.home') : route('web.home')}}"><img class="img-fluid"
                                                                       src="{{ asset('assets/web/images/logos/logo1.png') }}"
                                                                       alt="" style="width: 60px;"></a>
            </div>
            <div class="dark-logo-wrapper"><a href="{{isAdmin() ? route('admin.home') : route('web.home')}}"><img class="img-fluid"
                                                                            src="{{ asset('assets/web/images/logos/logo1.png') }}"
                                                                            alt="" style="width: 60px;"></a></div>
        ...
        <div class="nav-right col pull-right right-menu p-0">
            <ul class="nav-menus">
                ...
                <li class="onhover-dropdown p-0">
                    <form action="{{isAdmin() ? route('admin.logout') : route('web.logout')}}" method="POST">
                        @csrf
