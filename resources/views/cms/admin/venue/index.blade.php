                ...
                <div class="card">
                    <div class="card-header">
                        <div class="d-flex justify-content-between">
                            ...
                            <a class="btn btn-primary" href="{{route('admin.venues.create')}}">Create +</a>
                        </div>
                    </div>
                    <div class="card-body">
                            ...
                            <table class="display" id="venues">
                                ...
                                @forelse($venues as $venue)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{route('admin.venues.show',['id' => $venue->id])}}"
                                               style="cursor: pointer;"><i class="fa fa-eye" aria-hidden="true"></i></a>
                                            <a href="{{route('admin.venues.edit',['id' => $venue->id])}}"
    ...
    <script>
        ...
        function onDeleteVendor(id) {
            swal({
                ...
                .then(willDelete => {
                    if (willDelete) {
                        axios.delete(`/admin/venues/${id}/delete`)
                            .then(response => {
