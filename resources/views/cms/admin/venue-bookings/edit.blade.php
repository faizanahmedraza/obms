                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form method="POST" action="{{route('admin.venue-bookings.update',['id' => $booking->id])}}"
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <select class="form-control" name="venue" id="venue">
                                                    ...
                                                    @foreach($venues as $val)
                                                        <option value="{{$val->id}}" {{old('venue',$booking->venue_service_id) == $val->id ? 'selected' : ""}}>{{ucwords($val->venue_name)}} -- ({{ucwords($val->venue_type)}})</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
