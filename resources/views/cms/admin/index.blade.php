                ...
                <div class="row">
                    <div class="col-xl-12 col-md-12 box-col-12 des-xl-100">
                        <div class="card profile-greeting">
                            <div class="card-body text-center p-t-2">
                                <h3 class="font-light">Wellcome Back, {{ucwords(auth()->user()->name)}}!!</h3>
                                <p>Welcome to the obms Family! we are glad that you are visit our portal.
                    ...
                    <div class="col-xl-6 col-md-3 col-sm-6 box-col-3 des-xl-25 rate-sec">
                        <div class="card income-card card-primary">
                            ...
                            <g>
                                ...
                                <h5>8,50,49</h5>
                                <p>Vendors</p><a class="btn-arrow arrow-primary"
                    ...
                    <div class="col-xl-6 col-md-3 col-sm-6 box-col-3 des-xl-25 rate-sec">
                        <div class="card income-card card-secondary">
                            ...
                            <g>
                                ...
                                <h5>2,03,59</h5>
                                <p>Customers</p><a class="btn-arrow arrow-secondary"
                                                           href="javascript:void(0)"><i
