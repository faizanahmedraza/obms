                ...
                <div class="card">
                    <div class="card-header">
                        <div class="d-flex justify-content-between">
                            ...
                            <a class="btn btn-primary" href="{{route('vendor.vendors.create')}}">Create +</a>
                        </div>
                    </div>
                    <div class="card-body">
                            ...
                            <table class="display" id="vendors">
                                ...
                                @forelse($vendors as $vendor)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{route('vendor.vendors.show',['id' => $vendor->id])}}"
                                               style="cursor: pointer;"><i class="fa fa-eye" aria-hidden="true"></i></a>
                                            <a href="{{route('vendor.vendors.edit',['id' => $vendor->id])}}"
    ...
    <script>
        ...
        function onDeleteVendor(id) {
            swal({
                ...
                .then(willDelete => {
                    if (willDelete) {
                        axios.delete(`/vendor/vendors/${id}/delete`)
                            .then(response => {
