                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="d-flex justify-content-between">
                                    <h4 class="card-title">Edit Venue Service</h4>
                                    <a href="javascript:void(0)" onclick="window.history.go(-1)"
                                       class="btn btn-primary">← Back</a>
                                </div>
                            </div>
                            <div class="card-body">
                                <form method="POST" action="{{route('venue.venues.edit',['id' => $venue->id])}}"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" name="venue_type" id="venue_type">
                                                        ...
                                                        @foreach($venue_types as $val)
                                                            <option value="{{$val}}" {{old('venue_type',$venue->venue_type) == $val ? 'selected' : ""}}>{{ucwords($val)}}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="country" name="country"
                                                           placeholder="Enter Country" value="{{old('country',$venue->country)}}">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="address" name="address"
                                                           placeholder="Enter Address" value="{{old('address',$venue->address)}}">
                                                </div>
                                            </div>
